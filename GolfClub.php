...
$myfile = fopen("Learn_Input.dat", "a") or die("Unable to open file!");
$txt = $x_norm." ".$y_norm." ".$z_norm." ".$diff_x_y." ".$diff_x_z." ".$diff_y_z." ".$SwingType." "."\n";
fwrite($myfile, $txt);
fclose($myfile);

$myfile = fopen("Learn_Output.dat", "a") or die("Unable to open file!");
$txt = $SwingType." "."0"."\n";
fwrite($myfile, $txt);
fclose($myfile);
